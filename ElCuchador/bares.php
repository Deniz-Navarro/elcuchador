            ...
            <div class="col-lg-8 mt-2">
                <nav id="navbar-example2" class="navbar px-3 justify-content-center">
                    <ul class="nav nav-pills">
                        <li class="nav-item">
                            <a class="nav-link text-dark" href="#fam">Antro</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link text-dark" href="#buf">Billar</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link text-dark" href="#cr">Taberna</a>
                        </li>
                    </ul>
                </nav>
                <br><br>
                <div data-bs-spy="scroll" data-bs-target="#navbar-example2" data-bs-offset="0" tabindex="0">
                    <h4 id="fam">Antro</h4>
                        <div class="row">
                            <?php
                            $query = mysqli_query($conn,"SELECT * FROM publicaciones WHERE tcomida = 'Antro'");
                            card($query)
                            ?>
                        </div>
                    <h4 id="buf">Billar</h4>
                        <div class="row">
                            <?php
                            $query = mysqli_query($conn,"SELECT * FROM publicaciones WHERE tcomida = 'Billar'");
                            card($query)
                            ?>
                        </div>
                    <h4 id="cr">Taberna</h4>
                        <div class="row">
                            <?php
                            $query = mysqli_query($conn,"SELECT * FROM publicaciones WHERE tcomida = 'Taberna'");
                            card($query)
                            ?>
                        </div>
                </div>
